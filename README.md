...
- Everything is scoped to one signed-in account; there's no multi-user sharing/collaboration.your own Firebase project), and start adding ingredients, recipes, and a week of meals.
